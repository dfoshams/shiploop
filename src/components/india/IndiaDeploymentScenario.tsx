...
export const IndiaDeploymentScenario: React.FC<IndiaDeploymentScenarioProps> = ({
  ...
  const scenarios = [
    {
      ...
      retrofitTech: 'Flettner Rotor Sails (4 Medium Rotors)',
      annualFuel: DEMO_DATA.defaultSimulationParams.annualFuelConsumption,
      retrofitCost: DEMO_DATA.activePanamaxModel.retrofitCapexINR,
      efficiency: DEMO_DATA.activePanamaxModel.fuelEfficiencyImprovementPercent,
      fuelPrice: DEMO_DATA.activePanamaxModel.vlsfoPricePerTonneINR,
  ...
  const params: SimulationParams = {
    ...
    additionalProfitPeriodMonths: 0,
    tenureExtensionMonths: 0,
    bankSavingsSharePercent: 90,
    charterType: 'VOYAGE',
